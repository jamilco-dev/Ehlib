...
protected:
	...
	virtual void __fastcall MoveDataRowAndScroll(int Mouse, int CellHit, Grids::TGridDrawInfo &DrawInfo, Grids::TGridAxisDrawInfo &Axis, int ScrollBar, const Types::TPoint &MousePt);
...
//-- var, const, procedure ---------------------------------------------------
#define ColumnEhTitleValues (System::Set<TColumnEhValue, cvColor, cvBiDiMode> () << TColumnEhValue(5) << TColumnEhValue(6) << TColumnEhValue(7) << TColumnEhValue(8) << TColumnEhValue(9) << TColumnEhValue(10) << TColumnEhValue(11) << TColumnEhValue(12) )
